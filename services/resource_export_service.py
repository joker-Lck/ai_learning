...
class ResourceExportService:
    ...
    def _export_to_word(self, resource: Dict) -> Dict:
        ...
        try:
            ...
            error(f"导出Word文档失败: {str(e)}")
            return {
                "success": False,
                "message": f"导出Word文档失败: {str(e)}"
            }
    ...
    def _export_mindmap_to_jpg(self, resource: Dict) -> Dict:
        ...
        try:
            ...
            error(f"导出思维导图JPG失败: {str(e)}")
            return {
                "success": False,
                "message": f"导出思维导图JPG失败: {str(e)}"
            }
    ...
    def _export_script_to_txt(self, resource: Dict) -> Dict:
        ...
        try:
            ...
            error(f"导出脚本文件失败: {str(e)}")
            return {
                "success": False,
                "message": f"导出脚本文件失败: {str(e)}"
            }
    ...
    def _export_to_markdown(self, resource: Dict) -> Dict:
        ...
        try:
            ...
            error(f"导出Markdown文件失败: {str(e)}")
            return {
                "success": False,
                "message": f"导出Markdown文件失败: {str(e)}"
            }
