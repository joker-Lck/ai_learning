...
"%ROOT%.venv\Scripts\python.exe" -c "import mysql.connector; mysql.connector.connect(host='localhost',port=3306,user='root',password='root',connect_timeout=3)" >nul 2>&1
if errorlevel 1 echo [WARN] MySQL not reachable
