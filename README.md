...
- [性能指标](#性能指标)
- [常见问题](#常见问题)
- **[检索技术特点深度解析](RETRIEVAL_TECHNICAL_FEATURES.md)** ⭐ **NEW**
...
> **📖 详细技术文档**：关于检索技术的深度解析，请参阅 [检索技术特点深度解析](RETRIEVAL_TECHNICAL_FEATURES.md)，其中包含完整的架构图、代码实现、性能指标和创新总结。
